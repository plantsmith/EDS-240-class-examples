...
showtext_auto()
showtext_opts(dpi=300) #get dpi to match showtext and ggsave

#....................import Font Awesome fonts...................
# these are *actually* what we think of as icons
...
earnings_pal <- c("males" = "#2D7787",
                  "females" = "#FC6B4B",
                  "dark_text" = "#0C1509", #use these to color text elements 
                  "light_text" = "#4E514D") #use these to color text elements 
...
plot <- ggplot(subset_jobs) +
  geom_linerange(aes(y = occupation,
                     xmin = total_earnings_female, xmax = total_earnings_male)) + 
  geom_point(aes(x = total_earnings_male, y = occupation), 
             color = earnings_pal["males"], #update color here
             size = 2.5) +
  geom_point(aes(x = total_earnings_female, y = occupation), 
             color = earnings_pal["females"], #update color here
             size = 2.5) +
  ...
  theme(
    ...
    plot.caption = ggtext::element_textbox(family = "sen",
                                ...
                                width = unit(25, "cm"),
                                 ...
                                 padding = margin(t = 5, r = 0, b = 5, l = 0)),
    # left align and bold individual titles of plots (facets)
    strip.text = element_text(family = "josefin",
                              face = "bold",
                              size = rel(1.1), 
                              hjust = 0),
    # a bit more space between panels
    panel.spacing.y = unit(x = 0.5, "cm"),
    
    #adjust the text on the axis (all the occupation variables)
...
ggsave(
  filename = here::here("week6", "images", "salary_plot_5.png"),
